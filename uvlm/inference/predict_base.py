...
class nnUNetPredictor(object):
    ...
    def initialize_network_and_gaussian(self):
        ...
        """
        # Load first network parameters and set to evaluation mode
...
def predict_entry_point_modelfolder():
    ...
    parser = argparse.ArgumentParser(description='Use this to run inference with nnU-Net. This function is used when '
                                                 ...
                                                 'model. This is useful when the nnunetv2 environment variables '
    ...
    parser.add_argument('-device', type=str, default='cuda', required=False,
                        help="Use this to set the device the inference should run with. Available options are 'cuda' "
                             ...
                             "Use CUDA_VISIBLE_DEVICES=X nnUNet_predict [...] instead!")
...
def predict_entry_point():
    ...
    parser.add_argument('-num_parts', type=int, required=False, default=1,
                        help='Number of separate nnUNet_predict call that you will be making. Default: 1 (= this one '
                             'call predicts everything)')
    parser.add_argument('-part_id', type=int, required=False, default=0,
                        help='If multiple nnUNet_predict exist, which one is this? IDs start with 0 can end with '
                             'num_parts - 1. So when you submit 5 nnUNet_predict calls you need to set -num_parts '
    ...
    assert args.part_id < args.num_parts, 'Do you even read the documentation? See nnUNet_predict -h.'
...
if __name__ == '__main__':
    ...
    #                              save_probabilities=False, overwrite=False,
    #                              num_processes_preprocessing=2, num_processes_segmentation_export=2,
    #                              folder_with_segs_from_prev_stage='/media/isensee/data/imagesTs_predlowres',
    #                              num_parts=1, part_id=0)
